# P2 compatibility overlay for Juice Shop v17.3.0.
# The pinned upstream Dockerfile uses EOL Debian Buster mirrors. Keep the
# source checkout immutable and build the same stages on the maintained
# Bookworm image instead.
