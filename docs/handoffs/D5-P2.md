...
- `docs/handoffs/D5-P2.md`: 현재 P2 상태·검증·역할별 의존성을 기록.
...
- P2 관련 회귀 35건(`checked_in_manifests`, catalog, overlay, worktree test runner,
  target service, portability, lifecycle, readiness, apply-patch 연동) PASS.
