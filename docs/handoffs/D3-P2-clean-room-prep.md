...
- `26s-w1-c3-09`: detached target worktree `d4-c3-overlay-smoke`에서 generated run overlay 생성 →
  generated Compose `config --quiet` PASS → isolation compliant PASS. 검증 직후 approved worktree remove 확인.
